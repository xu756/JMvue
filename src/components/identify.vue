<template>
    <canvas id="s-canvas" @click="CreatYzm" :width="contentWidth" :height="contentHeight"></canvas>
</template>
<script>
export default {
    name: 'SIdentify',
    ...
    methods: {
        ...
        CreatYzm() {
            ...
            var codeChars = new Array(0,  2, 3, 4, 5, 6, 7, 8, 9,
        ...
        drawText(ctx, txt, i) {
            ...
            let y = this.randomNum(this.fontSizeMax, this.contentHeight - 1)
    ...
    created() {
        this.CreatYzm()
        this.$emit('GetYzm', this.identifyCode)
    }
}
</script>